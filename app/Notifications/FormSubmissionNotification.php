...
class FormSubmissionNotification extends Notification
{
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
                    ...
                    ->action('View Submission', url('/dashboard/submission/' .$this->formSubmission->form->slug . '/show/' . $this->formSubmission->id))
    ...
    public function toDatabase($notifiable): array
    {
        ...
        return [
            ...
            'url' => url('/dashboard/submission/' .$this->formSubmission->form->slug . '/show/' . $this->formSubmission->id),

import{b as Q,g as V,J as Y,R as W,d as F,j as i}from"./app-BCcrZTfm.js";var b={},B;function ee(){if(B)return b;B=1;function p(n){if(typeof window>"u")return;const u=document.createElement("style");return u.setAttribute("type","text/css"),u.innerHTML=n,document.head.appendChild(u),n}Object.defineProperty(b,"__esModule",{value:!0});var e=Q();function j(n){return n&&typeof n=="object"&&"default"in n?n:{default:n}}var t=j(e);p(`.rfm-marquee-container {
  overflow-x: hidden;
  display: flex;
  flex-direction: row;
  position: relative;

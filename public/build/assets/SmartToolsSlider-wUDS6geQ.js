...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})}const Nv=()=>ye.jsx("div",{className:"container-fluid relative",children:ye.jsxs("div",{className:"sec-padding pb-4",children:[ye.jsx("h2",{className:"text-[34px] mb-6 fc-secondary",children:"We Offer Smart Tools for Strategic Growth"}),ye.jsx("hr",{className:"border-white mb-8"}),ye.jsx("div",{className:"relative",children:ye.jsxs(eu,{modules:[Ev,tu],pagination:{clickable:!0,el:".swiper-pagination-custom"},autoplay:{delay:4e3,disableOnInteraction:!1},speed:1e3,spaceBetween:30,slidesPerView:1,className:"w-full custom-swiper",children:[[1,2,3].map((i,e)=>ye.jsx(nu,{children:ye.jsxs("div",{className:"flex flex-col md:flex-row",children:[ye.jsx("div",{className:"md:w-5/12 w-full",children:ye.jsx("img",{src:"/images/slider.png",alt:"Students in a smart classroom",className:"w-full h-[500px] object-cover"})}),ye.jsxs("div",{className:"md:w-7/12 w-full flex flex-col justify-between pt-4 pl-4 pb-0",children:[ye.jsxs("div",{children:[ye.jsx("h3",{className:"text-[30px] font-light fc-secondary mb-2",children:"Eduman"}),ye.jsx("p",{className:"text-[24px] fc-primary mb-2",children:"For Control, Clarity, & Campus-Wide Confidence"}),ye.jsx("p",{className:"text-[18px] fc-primary mb-2 w-[70%]",children:"Eduman is a cloud-based, SaaS (Software as a Service) system that simplifies the academic, administrative, and communication workflows for modern schools."})]}),ye.jsxs("button",{className:"group text-left text-[18px] fc-primary mb-2 flex items-center",children:[ye.jsx("span",{className:"inline-block border-b-2 border-transparent group-hover:border-current transition-all duration-200",children:"Click to Explore"}),ye.jsx("span",{className:"ml-3 fc-secondary transform transition-transform duration-200 group-hover:scale-125",children:"→"})]}),ye.jsxs("div",{className:"flex items-end justify-between",children:[ye.jsx("a",{href:"#",className:"inline-block text-left text-[18px] fc-purple font-light border-b-2 border-transparent hover:border-current transition-all duration-200",children:"View All Products"}),ye.jsx("img",{src:"/images/slider2.png",alt:"Roundabout",className:"w-[50%] h-auto rounded"})]})]})]})},e)),ye.jsx("div",{className:"swiper-pagination-custom absolute flex flex-col gap-2 z-10 align-items-end"})]})}),ye.jsx("hr",{className:"border-white mb-8"})]})});export{jd as D,Dv as G,Cv as P,Lv as R,Nv as S,Uv as T,Ge as V,Iv as W,Rv as a,Pv as b,Ct as c,Wd as d,wv as e};

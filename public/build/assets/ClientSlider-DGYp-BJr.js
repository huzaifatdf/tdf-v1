import{b as Q,g as V,J as Y,R as _,d as F,j as s}from"./app-D9pBRwG7.js";var b={},L;function ee(){if(L)return b;L=1;function v(t){if(typeof window>"u")return;const n=document.createElement("style");return n.setAttribute("type","text/css"),n.innerHTML=t,document.head.appendChild(n),t}Object.defineProperty(b,"__esModule",{value:!0});var e=Q();function j(t){return t&&typeof t=="object"&&"default"in t?t:{default:t}}var i=j(e);v(`.rfm-marquee-container {
  overflow-x: hidden;
  display: flex;
  flex-direction: row;
  position: relative;

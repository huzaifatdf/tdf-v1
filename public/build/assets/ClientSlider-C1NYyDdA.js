import{a as V,g as Y,q as F,R as _,d as ee,j as s}from"./app-C29a_2kn.js";var b={},L;function te(){if(L)return b;L=1;function h(t){if(typeof window>"u")return;const n=document.createElement("style");return n.setAttribute("type","text/css"),n.innerHTML=t,document.head.appendChild(n),t}Object.defineProperty(b,"__esModule",{value:!0});var e=V();function j(t){return t&&typeof t=="object"&&"default"in t?t:{default:t}}var i=j(e);h(`.rfm-marquee-container {
  overflow-x: hidden;
  display: flex;
  flex-direction: row;
  position: relative;

import{b as Q,g as V,q as Y,R as O,d as F,j as i}from"./app-DXc4CqHD.js";var x={},L;function ee(){if(L)return x;L=1;function b(t){if(typeof window>"u")return;const a=document.createElement("style");return a.setAttribute("type","text/css"),a.innerHTML=t,document.head.appendChild(a),t}Object.defineProperty(x,"__esModule",{value:!0});var e=Q();function q(t){return t&&typeof t=="object"&&"default"in t?t:{default:t}}var s=q(e);b(`.rfm-marquee-container {
  overflow-x: hidden;
  display: flex;
  flex-direction: row;
  position: relative;

...
const WhatsAppFloatButton = ({
  ...
  return (
    <div onClick={handleWhatsAppClick} className={`fixed ${positionClasses[position]} z-50  cursor-pointer`}>
      ...
      {/* Float Button */}
      <div className="relative group bg-[#9747FF] hover:bg-[#9BE500] rounded-full w-14 h-14 flex items-center justify-center">
        <button
        ...
        >
            ...
            <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="fill-[#fff] hover:fill-[#fff] group-hover:rotate-12 transition-transform duration-300"
                style={{

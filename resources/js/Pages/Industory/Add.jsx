...
export default function Add() {
  ...
  const handleSubmit = (values, { setSubmitting, resetForm }) => {
    ...
    router.post(route("industry.store"), formData, {
      forceFormData: true,
      onSuccess: () => {
        setSubmitting(false);
        resetForm();
                ...
                <Form className="space-y-6 bg-white p-6 rounded-lg shadow">
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
                      ...
                      <MediaLibraryModel routename={route('industry.create')} showModal={showImageMediaLibrary} setShowModal={setImageShowMediaLibrary} setFieldValue={setFieldValue}
                      fieldName="image"
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
                      ...
                      <MediaLibraryModel routename={route('industry.create')} showModal={showThumbnailMediaLibrary} setShowModal={setThumbnailShowMediaLibrary} setFieldValue={setFieldValue}
                        fieldName="thumbnail"

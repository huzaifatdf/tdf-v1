                ...
                <Form className="space-y-6 bg-white p-6 rounded-lg shadow">
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
                      ...
                      <MediaLibraryModel routename={route('service.create')} showModal={showImageMediaLibrary} setShowModal={setImageShowMediaLibrary} setFieldValue={setFieldValue}
                      fieldName="image"
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
                      ...
                      <MediaLibraryModel routename={route('service.create')} showModal={showThumbnailMediaLibrary} setShowModal={setThumbnailShowMediaLibrary} setFieldValue={setFieldValue}
                        fieldName="thumbnail"

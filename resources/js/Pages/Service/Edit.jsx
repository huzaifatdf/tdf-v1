...
export default function Edit() {
  const { service, additionalDataStructure,appUrl } = usePage().props;
  const [imagePreview, setImagePreview] = useState(appUrl + '/' + service.image || null);
  const [thumbnailPreview, setThumbnailPreview] = useState( appUrl + '/' + service.thumbnail || null);
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    router.post(route("service.update", service.id), formData, {
      forceFormData: true,
      onSuccess: () => {
        setSubmitting(false);
      },
  ...
  // Create initial values populated with existing service data
  const createInitialValues = () => {
    ...
    // Add initial values for additional data fields from existing service data
    const existingData = service.data ? JSON.parse(service.data) : {};
          ...
          />
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
                      ...
                      <MediaLibraryModel
                        routename={route('service.edit', service.id)}
                  ...
                  <div className="flex justify-end gap-3 pt-4">
                    <Button
                      type="button"
                      variant="outline"
                      onClick={() => router.get(route("service.index"))}
                    >
                      Cancel
                    </Button>

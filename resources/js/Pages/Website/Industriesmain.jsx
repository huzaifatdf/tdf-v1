      ...
      <div className="container-fluid">
        <div className="grid md:grid-cols-12 gap-12 border-b border-gray-800 pb-[60px]">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="space-y-3 pb-[60px]">
              <div className="text-[16px] fc-primary leading-relaxed">Branding & Design</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">Multilingual Website Design & Development</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">Internet Banking, Mobile Banking and Software</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">Customer Journey (UX/UI)</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">ATM Screens Design & User Journey</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">Digital Onboarding Solutions</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">Social Media Marketing</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">Search Engine Optimization (SEO)</div>
        ...
        <div className="grid md:grid-cols-12 gap-12 border-b border-gray-800 pt-[60px] pb-[60px]">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="space-y-3 pb-[60px]">
              <div className="text-[16px] fc-primary leading-relaxed">Brand and Content Planning</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">Developing MVPs (Minimum Viable Products)</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">Full Digital Presence</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">Website, App, SEO, and Social Channels</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">Integrated CRM Solution </div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">UX/UI Design</div>
              <div className="text-[16px] fc-primary leading-relaxed m-0">End-to-End Marketing Strategy </div>
